...
export default {
  ...
  methods: {
    ...
    getTemplateList() {
      this.tableData = submitted
    },
    editReport() {
      let id = queryReportById(this.form.id)
      submitted[id].name = this.form.name
      submitted[id].code = this.form.code
      submitted[id].type = this.form.type
      submitted[id].reporter = this.form.reporter
      submitted[id].phone = this.form.phone
      submitted[id].company = this.form.company
      submitted[id].lastModifier = this.form.lastModifier
      submitted[id].lastModifiedTime = dateToString(new Date())
      submitted[id].status = this.form.status
